...
<html>
  ...
  <body >
    <div>
      <b><span>CỬA HÀNG THỰC PHẨM SẠCH FRESH-FOOD</span></b>
      Số điện thoại: 0832100085<br>
      Website: http://localhost/Website_freshfood/
    </div><hr>
    ...
    <table>
      ...
      <tr>
        <td width="120px"><strong>Địa chỉ:</strong></td> <td>{!!$khachhang->khachhang_diachi!!}</td>
        <td></td>
      </tr>
      <tr>
      ...
      <tbody>
        <?php $count = 0; ?>
            ...
            <tr >
              ...
              <td style="border:thin blue solid;border-style:dashed;">{!! $val->chitietdonhang_soluong !!}</td>
              <td style="border:thin blue solid;border-style:dashed;">
              {!! number_format($val->chitietdonhang_thanhtien/$val->chitietdonhang_soluong,0,",",".") !!} vnđ 
              </td>
              
              <td style="border:thin blue solid;border-style:dashed;" >{!! number_format("$val->chitietdonhang_thanhtien",0,",",".") !!} vnđ </td>
          </tr>
            @endforeach
            <tr>
              <td  width="150px" >
    ...
    <table class="sumary-table">
      <tr>
        ...
        <td style="border:thin blue solid;border-style:dashed;" width="152px">{!! number_format($donhang->donhang_tongtien, 0, ",", ".") !!} vnđ</td>
      </tr>
      <tr>
        <td width="500px">Tổng giá trị</td>
        <td width="152px" style="border:thin blue solid;border-style:dashed;">{!! number_format($donhang->donhang_tongtien, 0, ",", ".") !!} vnđ</td>
      </tr>
    </table><br>
